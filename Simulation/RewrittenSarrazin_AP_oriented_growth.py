...
def configureSimulation(sim):
    ...
    PottsElmnt.ElementCC3D("Steps",{},"6001")
    ...
    PluginElmnt_7=CompuCell3DElmnt.ElementCC3D("Plugin",{"Name":"LengthConstraint"})
...
from  RewrittenSarrazinSteppables_AP_oriented_growth import jeremyVector
from  RewrittenSarrazinSteppables_AP_oriented_growth import EN_stripe

## ***** Declare Steppables Here ***** ##

from RewrittenSarrazinSteppables_AP_oriented_growth import VolumeStabilizer
s1 = VolumeStabilizer(sim,_frequency = 1)

from RewrittenSarrazinSteppables_AP_oriented_growth import AssignCellAddresses
s2 = AssignCellAddresses(sim,_frequency = 1)

from RewrittenSarrazinSteppables_AP_oriented_growth import SimplifiedForces_GrowthZone
s3 = SimplifiedForces_GrowthZone(sim,_frequency = 10)

# from RewrittenSarrazinSteppables_AP_oriented_growth import SimplifiedForces_EntireEmbryo
# s3 = SimplifiedForces_EntireEmbryo(sim,_frequency = 10)

from RewrittenSarrazinSteppables_AP_oriented_growth import Engrailed
...
from RewrittenSarrazinSteppables_AP_oriented_growth import CellExpansionForces
s6 = CellExpansionForces(sim,_frequency = 10)                      
...
if dye_flag:
   from RewrittenSarrazinSteppables_AP_oriented_growth import DyeCells
