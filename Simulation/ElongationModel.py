...
'''
params_path = '/Users/jeremyfisher/Dropbox/NagyLab - Shared with Terri/Params Files (for replicating batches)/batch 6 dampen oscillations.xml' #IO_MANAGER_FLAG_A_DO_NOT_CHANGE_THIS_COMMENT
